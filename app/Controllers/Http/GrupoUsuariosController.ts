...
export default class GrupoUsuariosController {
    ...
    try {
      ...
      switch (datosExistentes) {
        case 0:
          ...
          response.status(200).json({ "msg": "Usuario agregado al grupo con exito!" })
          break;
        case 1:
  ...
  private async getValidarGrupoUsuarioExistente(codigo_usuario: Number, codigo_grupo: Number): Promise<Number> {
